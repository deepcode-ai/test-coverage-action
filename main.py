...
DEEPCODE_CLI_PATH = "/app/bin/deepcode"

DEEPCODE_TEST_COVERAGE_ANALYZER_SHORTCODE = "test-coverage"
...
def main() -> None:
    """
    Get the metadata required for invoking DeepCode CLI from the environment
    ...
    command = [
        ...
        "report",
        "--analyzer",
        DEEPCODE_TEST_COVERAGE_ANALYZER_SHORTCODE,
        "--key",
        input_data["key"],
        "--value-file",
